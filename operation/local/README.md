# Running the festivals fileserver locally on you mac
...
## Running the festivals fileserver
...
```text
https://fileserver-0.festivalsapp.dev:1910
```
...
```bash
curl -H "Authorization: Bearer <JWT>" --cert /opt/homebrew/etc/pki/issued/client.crt --key /opt/homebrew/etc/pki/private/client.key --cacert /opt/homebrew/etc/pki/ca.crt https://fileserver-0.festivalsapp.dev:1910/info
```
